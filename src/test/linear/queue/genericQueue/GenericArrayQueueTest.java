...
import structures.linear.queue.genericQueue.GenericArrayQueue;

import static org.junit.jupiter.api.Assertions.*;
import static org.junit.jupiter.api.Assertions.assertEquals;

/**
 * Test for class GenericArrayQueue
 *
 * @author Rackumi
 */
public class GenericArrayQueueTest {

    GenericArrayQueue<Integer> queue;
    final int MAX=25;

    @org.junit.jupiter.api.BeforeEach
    void setUp(){
        queue = new GenericArrayQueue<>(10);
        for (int i = 0; i < MAX; i++) {
            queue.enqueue(i);
        }
    }
    ...
    void testResize(){
        ...
        Assumptions.assumeTrue(queue instanceof GenericArrayQueue, "Not an instance of ArrayQueue");

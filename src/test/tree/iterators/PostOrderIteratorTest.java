...
import structures.tree.iterators.PostOrderIterator;
import structures.tree.narytree.LinkedTree;
import static org.junit.Assert.*;

/**
 * Test class for PostOrderIterator
 *
 * @author Rackumi
 */
public class PostOrderIteratorTest {
    
    public PostOrderIteratorTest() {
    }
    ...
    public void testIterator() {
        ...
        String salida = "";
        PostOrderIterator<String> it = new PostOrderIterator<>(t);
        while (it.hasNext()) {

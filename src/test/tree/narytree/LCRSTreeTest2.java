...
/**
 * Test2 class for LCRSTree
 *
 * @author Rackumi
 */
public class LCRSTreeTest2 {
    ...
    void moveSubtreeExcept() {
        ...
        assertEquals("Target position can't be a subtree of origin", thrown2.getMessage());

        RuntimeException thrown3 = assertThrows(RuntimeException.class,
                () -> tree.moveSubtree(pos[4], pos[4]));
        assertEquals("Both positions are the same", thrown3.getMessage());
    }

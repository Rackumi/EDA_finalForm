...
public interface NAryTree<E> extends Tree<E> {
   ...
   /**
    ...
    //lo necesitamos aunke no sea eficiente
    public int size();

    /**
     * Converts the nary tree into a binary tree. Examen ordinaria_2020_2021
     */
    BinaryTree<E> convertToBinaryTree();
}
package structures.notOrderedMapsAndDictionaries.dictionaries1;

import structures.notOrderedMapsAndDictionaries.Entry;
import java.util.*;

/**
 * Separate chaining table implementation of hash tables in dicionaries. Note that all "matching" is based on the equals method.
 *
 * @author Rackumi
 */

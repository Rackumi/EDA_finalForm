 ...
 * @author Rackumi
 */
public class QuickBinaryTree<E> implements BinaryTree<E> {

    private Map<E,Position<E>> map = new HashTableMapDH<>();
    ...
    public QuickBinaryTree(BTNode<E> root){
        this.root = root;
    }
...
//        node2.setElement(aux);
    ...
    @Override
    public QuickBinaryTree<E> subTree(Position<E> h) {
        BTNode<E> node = checkPosition(h);
        BTNode<E> parent = node.getParent();
        QuickBinaryTree<E> t = new QuickBinaryTree<>(node);
    ...
    public Position<E> searchQuickBinaryTree(E e){
        return map.get(e);
    }

...
public class WeightedLinkedTree<E> implements Tree<E> {
    ...
    private class TreeNode<T> implements Position<T> {
         ...
         * Main constructor
         */
        public TreeNode(WeightedLinkedTree<T> t, T e, TreeNode<T> p, LinkedList<TreeNode<T>> c) {
            this.element = e;
            this.parent = p;
            this.children = c;
            this.myTree = t;
         ...
         */
        public final void setChildren(LinkedList<TreeNode<T>> c) {
            children = c;
        }
    ...
    public Position<E> addRoot(E e) {
        ...
        root = new TreeNode<>(this, e, null, new LinkedList<>());
        root.setWeight(0);
        return root;
    }
    ...
    public Position<E> add(E element, Position<E> p, final int weight) {
        ...
        TreeNode<E> newNode = new TreeNode<>(this, element, parent, new LinkedList<>());

...
class CommonAncestorTreeTest {
    ...
    */
    ...
    void test1() {
        ...
        NAryTree<Integer> result = cat.createCommonTreeAncestor(p[3], p[7]);
    ...
    void test2() {
        CommonAncestorTree<Integer> cat = new CommonAncestorTree<>(tree);
        NAryTree<Integer> result = cat.createCommonTreeAncestor(p[2], p[7]);
    ...
    void test3() {
        CommonAncestorTree<Integer> cat = new CommonAncestorTree<>(tree);
        NAryTree<Integer> result = cat.createCommonTreeAncestor(p[6], p[7]);
        String expected = "678";
        StringBuilder stb = new StringBuilder();
        for (Position<Integer> p : result) {
            stb.append(p.getElement());
    ...
    void test4() {
        CommonAncestorTree<Integer> cat = new CommonAncestorTree<>(tree);
        NAryTree<Integer> result = cat.createCommonTreeAncestor(p[5], p[7]);
        String expected = "678";
        StringBuilder stb = new StringBuilder();
        for (Position<Integer> p : result) {
            stb.append(p.getElement());
